  ...
  return (
    <div className="resume-viewer">
      <div className="resume-toolbar">
        <span className="pixel-font" style={{ fontSize: '10px', color: 'var(--ink)' }}>
          RESUME.PDF
        </span>
      ...
      <div className="resume-content-scroll">
        <div className="resume-details">
          <div className="resume-section">
            <h3 className="pixel-font">EXPERIENCE</h3>
            <div style={{ marginBottom: '16px' }}>
              <p style={{ margin: '0 0 4px', fontWeight: 'bold' }}>Full Stack AI Engineer — Algowire Technologies</p>
              <p style={{ margin: '0 0 4px', color: 'var(--ink-soft)', fontSize: '15px' }}>Jun 2026 — Jul 2026</p>
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              <p style={{ margin: '0 0 4px', color: 'var(--ink-soft)', fontSize: '15px' }}>Jun 2025 — Jul 2025</p>
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              <p style={{ margin: '0 0 4px', color: 'var(--ink-soft)', fontSize: '15px' }}>Aug 2025 — May 2026</p>
          ...
          <div className="resume-section">
            <h3 className="pixel-font">EDUCATION</h3>
          ...
          <div className="resume-section">
            <h3 className="pixel-font">HOBBIES & INTERESTS</h3>
