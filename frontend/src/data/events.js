...
export const EVENTS = [
  ...
  // ============================================================
  event({
    id: 'microsoft-gurugram',
    category: 'conferences',
    name: 'Microsoft Gurugram',
    year: '2024',
    role: 'Participant — Technical Learning Program',
    description: 'Technical learning program at Microsoft Gurugram campus. Hands-on sessions with Microsoft technologies, cloud infrastructure, and developer tools. Networking with engineers and industry professionals.',
    tags: ['Microsoft', 'Cloud', 'Technical Learning', 'Developer Tools'],
    // images: [
    //   { src: '/events/microsoft/building.jpg', alt: 'Microsoft Gurugram', caption: 'Microsoft Gurugram campus' },
    //   { src: '/events/microsoft/event.jpg', alt: 'Microsoft Gurugram Event', caption: 'Event photo' },
  ...
  event({
    id: 'azure-learning-academy',
    category: 'conferences',
    name: 'Azure Learning Academy',
    year: '2024',
    role: 'Participant — Top Recognition',
    description: 'Azure-focused training program with hands-on labs covering cloud services, AI/ML on Azure, container orchestration, and serverless computing. Recognized among top participants for project work and engagement.',
    tags: ['Azure', 'Cloud', 'AI/ML', 'Containers', 'Serverless', 'Top Participant'],
    // images: [
    //   { src: '/events/azure/labs.jpg', alt: 'Azure Learning Academy Labs', caption: 'Hands-on labs' },
    //   { src: '/events/azure/recognition.jpg', alt: 'Azure Recognition', caption: 'Top participant recognition' },
    // ],
    featured: false,
    externalLink: '',
  }),
